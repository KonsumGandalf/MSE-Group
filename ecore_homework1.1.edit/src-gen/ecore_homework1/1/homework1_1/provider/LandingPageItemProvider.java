...
/**
 * This is the item provider adapter for a {@link ecore_homework1.1.homework1_1.LandingPage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LandingPageItemProvider extends WebpageItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LandingPage_welcomeMessage_feature", "_UI_LandingPage_type"),
				 Homework1_1Package.Literals.LANDING_PAGE__WELCOME_MESSAGE,
				 true,
				 false,
				 false,
	...
	{
		String label = ((LandingPage)object).getURL();
		return label == null || label.length() == 0 ?
			getString("_UI_LandingPage_type") :
