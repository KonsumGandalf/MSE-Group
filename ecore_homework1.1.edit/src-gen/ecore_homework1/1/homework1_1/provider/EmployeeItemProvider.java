...
/**
 * This is the item provider adapter for a {@link ecore_homework1.1.homework1_1.Employee} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Employee_employeeID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Employee_employeeID_feature", "_UI_Employee_type"),
				 Homework1_1Package.Literals.EMPLOYEE__EMPLOYEE_ID,
				 true,
				 false,
				 false,
	...
	protected void addPositionPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Employee_position_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Employee_position_feature", "_UI_Employee_type"),
				 Homework1_1Package.Literals.EMPLOYEE__POSITION,
				 true,
				 false,
				 false,
