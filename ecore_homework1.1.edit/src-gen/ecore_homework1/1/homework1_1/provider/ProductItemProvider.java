...
/**
 * This is the item provider adapter for a {@link ecore_homework1.1.homework1_1.Product} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Homework1_1Package.Literals.PRODUCT__PRODUCT_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Homework1_1Package.Literals.PRODUCT__PRICE,
				 true,
				 false,
				 false,
	...
	protected void addTitlePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Product_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Product_title_feature", "_UI_Product_type"),
				 Homework1_1Package.Literals.PRODUCT__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addInStockPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Product_inStock_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Product_inStock_feature", "_UI_Product_type"),
				 Homework1_1Package.Literals.PRODUCT__IN_STOCK,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(Homework1_1Package.Literals.PRODUCT__CARTITEM);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(Homework1_1Package.Literals.PRODUCT__CARTITEM,
