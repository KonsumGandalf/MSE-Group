...
/**
 * This is the item provider adapter for a {@link ecore_homework1.1.homework1_1.Order} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Homework1_1Package.Literals.ORDER__STATUS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(Homework1_1Package.Literals.ORDER__PAYMENT);
			childrenFeatures.add(Homework1_1Package.Literals.ORDER__CUSTOMER);
			childrenFeatures.add(Homework1_1Package.Literals.ORDER__EMPLOYEE);
		}
	...
	public String getText(Object object)
	{
		...
		return getString("_UI_Order_type") + " " + order.isIsActive();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(Homework1_1Package.Literals.ORDER__PAYMENT,
				 Homework1_1Factory.eINSTANCE.createPayment()));

		newChildDescriptors.add
			(createChildParameter
				(Homework1_1Package.Literals.ORDER__CUSTOMER,
				 Homework1_1Factory.eINSTANCE.createCustomer()));

		newChildDescriptors.add
			(createChildParameter
				(Homework1_1Package.Literals.ORDER__EMPLOYEE,
