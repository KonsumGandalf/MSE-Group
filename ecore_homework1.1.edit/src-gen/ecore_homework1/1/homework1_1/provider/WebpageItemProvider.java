...
/**
 * This is the item provider adapter for a {@link ecore_homework1.1.homework1_1.Webpage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Webpage_URL_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Webpage_URL_feature", "_UI_Webpage_type"),
				 Homework1_1Package.Literals.WEBPAGE__URL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Homework1_1Package.Literals.WEBPAGE__TITLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	{
		String label = ((Webpage)object).getURL();
