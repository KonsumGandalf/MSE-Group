 ...
 * </p>
 * <ul>
 *   <li>{@link ecore_homework1.1.homework1_1.impl.UserImpl#getEmailAddress <em>Email Address</em>}</li>
 *   <li>{@link ecore_homework1.1.homework1_1.impl.UserImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UserImpl extends MinimalEObjectImpl.Container implements User
{
	...
	{
		return Homework1_1Package.Literals.USER;
	}
	...
	public void setEmailAddress(String newEmailAddress)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Homework1_1Package.USER__EMAIL_ADDRESS, oldEmailAddress, emailAddress));
	}
	...
	public void setName(String newName)
	{
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Homework1_1Package.USER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Homework1_1Package.USER__EMAIL_ADDRESS:
				return getEmailAddress();
			case Homework1_1Package.USER__NAME:
				return getName();
		}
