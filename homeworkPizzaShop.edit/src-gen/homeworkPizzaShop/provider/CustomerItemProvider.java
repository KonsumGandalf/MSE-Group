...
/**
 * This is the item provider adapter for a {@link homeworkPizzaShop.Customer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomerItemProvider extends UserItemProvider {
	...
	protected void addCustomerIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Customer_customerID_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Customer_customerID_feature",
								"_UI_Customer_type"),
						HomeworkPizzaShopPackage.Literals.CUSTOMER__CUSTOMER_ID, true, false, false,
	...
	protected void addCustomerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Customer_customer_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Customer_customer_feature",
								"_UI_Customer_type"),
						HomeworkPizzaShopPackage.Literals.CUSTOMER__CUSTOMER, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HomeworkPizzaShopPackage.Literals.CUSTOMER__CUSTOMER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(HomeworkPizzaShopPackage.Literals.CUSTOMER__CUSTOMER,
				HomeworkPizzaShopFactory.eINSTANCE.createOrder()));
	}
