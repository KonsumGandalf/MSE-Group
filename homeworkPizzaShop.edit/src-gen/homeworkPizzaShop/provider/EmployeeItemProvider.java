...
/**
 * This is the item provider adapter for a {@link homeworkPizzaShop.Employee} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EmployeeItemProvider extends UserItemProvider {
	/**
	...
	protected void addEmployeeIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Employee_employeeID_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Employee_employeeID_feature",
								"_UI_Employee_type"),
						HomeworkPizzaShopPackage.Literals.EMPLOYEE__EMPLOYEE_ID, true, false, false,
	...
	protected void addPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Employee_position_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Employee_position_feature",
								"_UI_Employee_type"),
						HomeworkPizzaShopPackage.Literals.EMPLOYEE__POSITION, true, false, false,
