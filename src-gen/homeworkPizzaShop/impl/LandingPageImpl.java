 ...
 * </p>
 * <ul>
 *   <li>{@link homeworkPizzaShop.impl.LandingPageImpl#getWelcomeMessage <em>Welcome Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LandingPageImpl extends WebpageImpl implements LandingPage {
	...
	protected EClass eStaticClass() {
		return HomeworkPizzaShopPackage.Literals.LANDING_PAGE;
	}
	...
	public void setWelcomeMessage(String newWelcomeMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					HomeworkPizzaShopPackage.LANDING_PAGE__WELCOME_MESSAGE, oldWelcomeMessage, welcomeMessage));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case HomeworkPizzaShopPackage.LANDING_PAGE__WELCOME_MESSAGE:
			return WELCOME_MESSAGE_EDEFAULT == null ? welcomeMessage != null
					: !WELCOME_MESSAGE_EDEFAULT.equals(welcomeMessage);
		}
